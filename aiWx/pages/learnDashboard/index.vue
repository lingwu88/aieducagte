  ...
  methods: {
    ...
    generateWordCloudData() {
      ...
      const keywords = [
        ...
        { word: '算法', weight: 85, description: '算法是您频繁提及的概念，表明您对计算机科学基础很感兴趣。', suggestion: '可以尝试刷题平台如LeetCode来提升算法能力。' },
        { word: '数据结构', weight: 70 },
        { word: 'Python', weight: 65, description: 'Python是您常用的编程语言，您对它有较高的兴趣。', suggestion: '建议学习Python高级特性和流行框架如Django或Flask。' },
        { word: '机器学习', weight: 60 },
        { word: '深度学习', weight: 55 },
    ...
    fetchWordCloudData() {
      ...
      // 示例代码：
      // uni.request({
      //   url: 'https://api.example.com/chat-keywords',
      //   method: 'GET',
      //   success: (res) => {
